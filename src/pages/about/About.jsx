...
function About() {
  return (
    <section className=" bg-gradient-to-r from-purple-300 to-pink-500 text-gray-900 px-4 py-28">
    <div className="container mx-auto">
      {/* Hero Section with Animated Background */}
      <div className="mb-16 relative text-center">
        <div className="absolute inset-0 bg-gradient-to-r from-pink-500 opacity-50 blur-lg"></div>
        <motion.h1
        ...
        <p className="relative text-gray-100 text-lg max-w-2xl mx-auto mt-6 leading-relaxed">
      ...
      <div className="mb-12 bg-gradient-to-r from-rose-500 to-pink-500 p-10 rounded-lg shadow-lg text-white text-center">
      ...
      <div className="mb-12 text-center">
        <h2 className="text-4xl font-bold mb-8 text-pink-600">Why EaseLearn?</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {[
            ...
            >
              <h3 className="text-2xl font-semibold mb-2 text-pink-600">{feature.title}</h3>
      ...
      <div className="mb-16">
        <h2 className="text-4xl font-bold text-center mb-12 text-pink-600">Meet Our Team</h2>
      ...
      <div className="mb-16 text-center">
        <h2 className="text-4xl font-bold mb-8 text-pink-600">Our Impact</h2>
        <div className="flex flex-wrap justify-center gap-10">
          {[
            ...
            >
              <h3 className="text-5xl font-bold text-rose-600">{stat.value}</h3>
      ...
      <div className="text-center bg-gradient-to-r from-rose-500 to-pink-500 py-12 rounded-lg">
        ...
        <motion.a
          href="/courses"
          className="inline-block bg-white text-pink-600 py-3 px-8 rounded-full font-semibold shadow-lg hover:bg-gray-100 transition duration-300"
          whileHover={{ scale: 1.05 }}
        >
          Get Started
        </motion.a>
