...
function Account({ user }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-purple-300 to-pink-500 text-gray-800 py-16 px-4">
    {user && (
      <div className="container mx-auto">
        {/* Profile Section */}
        <section className="profile flex flex-col md:flex-row items-center bg-white/80 p-6 rounded-lg shadow-md mb-12">
        ...
        {/* Recent Activity */}
        <section className="recent-activity bg-white/80 p-6 rounded-lg shadow-md mb-12">
          <h2 className="text-2xl font-semibold text-gray-900 mb-6">Recent Activities</h2>
          <div className="activity-list space-y-4">
            <div className="activity-item flex justify-between items-center border-b border-gray-300 pb-4">
              <span className="font-medium text-gray-800">Completed "JavaScript for Beginners"</span>
              <span className="text-sm text-gray-600">2 days ago</span>
            </div>
            <div className="activity-item flex justify-between items-center border-b border-gray-300 pb-4">
              <span className="font-medium text-gray-800">Enrolled in "React Mastery"</span>
              <span className="text-sm text-gray-600">1 week ago</span>
            </div>
            <div className="activity-item flex justify-between items-center">
              <span className="font-medium text-gray-800">Joined a live session on "Node.js"</span>
        ...
        {/* Enrolled Courses */}
        <section className="enrolled-courses bg-white/80 p-6 rounded-lg shadow-md mb-12">
          <h2 className="text-2xl font-semibold text-gray-900 mb-6">Your Enrolled Courses</h2>
          <div className="course-list grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="course-card bg-gray-100 p-4 rounded-lg shadow-lg hover:shadow-xl transition duration-300 ease-in-out">
              <h3 className="font-bold text-lg mb-2">React for Beginners</h3>
              <p className="text-sm text-gray-700">50% completed</p>
              <div className="progress-bar bg-gray-300 h-2 rounded-full mt-2">
                <div className="bg-blue-500 h-2 rounded-full" style={{ width: '50%' }}></div>
              </div>
            </div>
            <div className="course-card bg-gray-100 p-4 rounded-lg shadow-lg hover:shadow-xl transition duration-300 ease-in-out">
              <h3 className="font-bold text-lg mb-2">Advanced JavaScript</h3>
              <p className="text-sm text-gray-700">75% completed</p>
              <div className="progress-bar bg-gray-300 h-2 rounded-full mt-2">
            ...
            <div className="course-card bg-gray-100 p-4 rounded-lg shadow-lg hover:shadow-xl transition duration-300 ease-in-out">
              ...
              <p className="text-sm text-gray-700">20% completed</p>
              <div className="progress-bar bg-gray-300 h-2 rounded-full mt-2">
        ...
        {/* Account Information */}
        <section className="account-info bg-white/80 p-6 rounded-lg shadow-md">
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-between items-center border-b border-gray-300 pb-2">
              ...
              <span className="text-gray-700">+1-202-555-0190</span>
            </div>
            <div className="flex justify-between items-center border-b border-gray-300 pb-2">
