...
//   return (
//     <div className="w-full flex justify-between items-center px-10 py-6 bg-gradient-to-r from-purple-300  to-pink-500 text-white ">
//       <div className="right flex">
//         <h1 className="text-4xl font-semibold ">
//           Ease<span className="text-pink-400">Learn</span>
//         </h1>
//       </div>
//       <div className="left hidden sm:block text-lg tracking-tighter">
//         <div className="links flex gap-6">
//           <NavLink
//             className="text-xl  font-medium transition-colors hover:underline duration-200 hover:text-pink-900"
//             to="/"
//           >
//             Home
//           </NavLink>
...
//             className="fixed top-0 left-0 h-screen w-[100vw] sm:w-[50vw] bg-gradient-to-r from-purple-300  to-pink-500 z-40 flex flex-col justify-center items-start p-8"
//           >
//             <h2 className="text-3xl text-white font-semibold mb-8">
//               Ease<span className="text-yellow-400">Learn</span>
//             </h2>
//             <NavLink
//               className="text-2xl font-medium text-white mb-6 transition-colors duration-200 hover:text-pink-900"
//               to="/"
//               onClick={toggleMenu}
//             >
//               Home
        ...
        {isOpen ? (
          <>
            ...
            <motion.div
              ...
              exit={{ x: "-100%" }}
              transition={{ duration: 0.4, ease: "easeInOut" }}
              className="fixed top-0 left-0 h-screen w-full bg-black bg-opacity-90 z-40 flex flex-col justify-center items-start p-8"
            >
